...
namespace CLINICSYSTEM.Services
{
    public interface IDoctorService
    {
        ...
        Task<NurseListDTO?> GetAssignedNurseAsync(int doctorId);
        Task<bool> AssignNurseToDoctorAsync(int doctorId, int nurseId);
        Task<bool> AssignTaskToNurseAsync(int doctorId, CreateNurseTaskRequest request);
        Task<int> GetTotalDoctorCountAsync();
        Task<int> GetTotalNurseCountAsync();
    }
}
