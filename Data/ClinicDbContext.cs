...
namespace CLINICSYSTEM.Data
{
    public class ClinicDbContext : IdentityDbContext
    {
        ...
        public DbSet<NurseTaskModel> NurseTasks { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NurseTaskModel>()
                .HasKey(nt => nt.TaskId);
            ...
            modelBuilder.Entity<NurseTaskModel>()
                ...
                .HasForeignKey(nt => nt.NurseId)
                .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<NurseTaskModel>()
                .HasOne(nt => nt.Doctor)
                .WithMany()
                .HasForeignKey(nt => nt.DoctorId)
                .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<NurseTaskModel>()
                .HasOne(nt => nt.RelatedAppointment)
                .WithMany()
                .HasForeignKey(nt => nt.RelatedAppointmentId)
                .OnDelete(DeleteBehavior.SetNull);
